...
//					return res.redirect("/");
//			}
//			Promise.all([Post.findPostByWordPageModel(word, offset, limit),
//					Term.getAllCategory(),
//					Term.getAllTags(),
//					Post.findArticleArchive(),
//					Post.findNewestList(),
...
//			Promise.all([Post.findByYearMonthPageModel({year: year, month: month}, offset, limit),
//					Term.getAllCategory(),
//						Term.getAllTags(),
//					Post.findArticleArchive(),
//					Post.findNewestList(),
...
//			} else {
//				Promise.all([Post.findByCategoryPageModel(pargs1, offset, limit),
